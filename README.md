...
```
PowerShell -executionpolicy bypass -command "wget https://github.com/devmalya-b/kWSL/raw/master/kWSL.cmd -UseBasicParsing -OutFile kWSL.cmd ; .\kWSL.cmd"
```
...
You can also switch back to WSL1: ````wsl --set-version NeonWSL 1````
